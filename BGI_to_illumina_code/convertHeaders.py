...
def parseBGI(header):
    ...
    if header[-10] == "_":
        ...
        elements_dict = {"instrument": "MGISEQ-2000", "run_number": 1, "sample_barcode": sample_barcode.strip("\n"), "lane": lane_id, "x-pos": x_id, "y-pos": y_id, "tile": tile_number, "flowcell-id": flowcell_id, "read_no": paired_read_direction}
...
if __name__ == "__main__":
    ...
    for idx, line in enumerate(input_fastq):
        #pdb.set_trace()
        #print("processing", idx)
        parsed_line = parseLine(line, idx)
